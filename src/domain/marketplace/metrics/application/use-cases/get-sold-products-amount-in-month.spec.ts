...
import { GetSoldProductsAmountInMonthUseCase } from './get-sold-products-amount-in-month'
...
let sut: GetSoldProductsAmountInMonthUseCase

describe('Get sold products amount use case', () => {
  beforeEach(() => {
    ...
    sut = new GetSoldProductsAmountInMonthUseCase(
      inMemorySellersRepository,
      inMemoryProductsRepository,
    )
  })

  it('should be able to count sold products by seller', async () => {
  ...
  it('should not be able to count sold products by a non-existent seller', async () => {
    const result = await sut.execute({
